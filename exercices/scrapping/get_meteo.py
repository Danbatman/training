...
def parse(day, month, year):
    # try:
        soup = BeautifulSoup(urllib2.urlopen("http://www.meteociel.fr/temps-reel/obs_villes.php?code2=7156&jour2=%s&mois2=%s&annee2=%s&envoyer=OK" % (day, month-1, year)).read())
